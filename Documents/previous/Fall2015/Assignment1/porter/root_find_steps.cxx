...
void root_find_steps() {
	//Draw a simple graph
	// To see the output of this macro, click begin_html <a href="gif/graph.gif">here</a>. end_html
	//Author: Rene Brun
	//
	//Modified: Edward J. Brash, to find roots of a cubic polynomial, using bisection method
	//Modified: Samuel Porter, to find steps taked vs. chunk size
  
	gStyle->SetOptFit(kFALSE);	
	TCanvas *c1 = new TCanvas("c1","Root Finding Example",200,10,1000,700);

...
double myFunction(double x)
{
	...
	double y = param[0] + param[1]*x + param[2]*x*x + param[3]*x*x*x;
	//Feel free to substitute any function for the above
	return y;
}

void graph_root_partE() {
   //Draw a simple graph
...
//* Initialize the polynomial
  int nroots_known = 3; //change this based on the function in myFunction()
  double a0 = 1.80;
  double a1 = -4.05;
  double a2 = 0.40;
  double a3 = 1.00;

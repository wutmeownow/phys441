...
void stepvspart() {
	...
	Double_t* steps = new Double_t[20];
   ...
   c1->SetFillColor(42);
   c1->SetGrid();
	TGraph* g = new TGraph(20,part,steps);
   g->SetMarkerStyle(22);
   g->SetTitle("Steps vs Particles");
   g->GetXaxis()->SetTitle("Particles");
   g->GetYaxis()->SetTitle("Steps");
   g->Draw("ALP");
	c1->Update();

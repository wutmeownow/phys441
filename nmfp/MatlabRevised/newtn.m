...
fnewtName = input('Enter name of function (e.g., fnewt): ','s');
fnewtH = str2func(fnewtName);   % Convert name into function handle
...
for iStep=1:nStep
  ...
  [f D] = fnewtH(x,a);      % fnewt returns value of f and D

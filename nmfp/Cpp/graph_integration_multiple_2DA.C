...
Double_t myfunction(Double_t x, Double_t y)
{
        Double_t xx = x;
	Double_t yy = y;

	Double_t f = 9.0/4.0*(1.0 - xx*xx)*(1.0 - yy*yy);

	return f;
}

void graph_integration_multiple_2DA(Int_t max_order = 4, Int_t nbins = 20, Int_t min_order = 2) {

...
def int2ordinal (user_integer):
    ending = ['th','st','nd','rd']
    lastdigit = int(user_integer%10)
    seconddigit =int ((user_integer%100 - user_integer%10)/10)
    choice = int(seconddigit!=1)*(1-int(lastdigit>3))*lastdigit
    return str(user_integer)+ending[choice]

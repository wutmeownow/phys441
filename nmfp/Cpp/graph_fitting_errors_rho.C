...
Double_t generating_function(Double_t x)
{
        ...
        Double_t f = par[0]+par[1]*x;

        return f;
}

void graph_fitting_errors_rho() {
   //
   ...
   Int_t i;
   Double_t walk[n]={.3,.2,-.5,-.2,.2,.6,-.4,-1.5,.7,.5};
   Double_t sigma[n]={0.51,0.51,0.51,0.51,0.51,0.51,0.51,0.51,0.51,0.51};

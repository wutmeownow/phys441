...
w = wire.Wire(path=wire.Wire.SolenoidPath(pitch=0.005, turns=100), discretization_length=0.01, current=10000).Rotate(axis=(1, 0, 0), deg=90) #.Translate((0.1, 0.1, 0)).
...
grid = np.mgrid[volume_corner1[0]:volume_corner2[0]:resolution*rfac, volume_corner1[1]:volume_corner2[1]:resolution*rfac, volume_corner1[2]:volume_corner2[2]:resolution*rfac]
